...
class _MenuState extends State<Menu> {
  ...
  void initState() {
    super.initState();
    getNombrePunto(); // Obtén el nombre del punto al inicializar el estado
    getDomiciliarios();
  }
  ...
  void getNombrePunto() async {
    ...
    setState(() {
      nombrePunto = nombre ?? ''; // Asigna el nombre del punto a la variable nombrePunto
    });
  }
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await http
                      .put(
                    Uri.parse('http://localhost:8080/impresora'),
                    body: json.encode({'idPunto': prefs.getInt('IDPunto')}),
                  )
                      .then((response) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return const AlertDialog(
          content: Text("Prueba de Impresora Enviada"),
        );
      },
    );
  }
